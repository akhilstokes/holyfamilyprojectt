...
router.get('/calculate/:workerId', protect, dailyWageController.calculateMonthlySalary);
router.get('/calculate-enhanced/:workerId', protect, dailyWageController.calculateEnhancedSalary);
...
router.get('/summary/:workerId', protect, dailyWageController.getSalarySummary);
