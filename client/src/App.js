...
// import ManagerAttendance from "./pages/manager/ManagerAttendance"; // File doesn't exist
...
// import LabAttendance from "./pages/lab/LabAttendance"; // File doesn't exist
...
import AccountantAuditTrail from "./pages/accountant/AccountantAuditTrail";
import AccountantProfitability from "./pages/accountant/AccountantProfitability";
...
import AccountantBranches from "./pages/accountant/AccountantBranches";
...
// import StaffAttendance from "./pages/staff/StaffAttendance"; // File doesn't exist
...
import TodayPickups from "./pages/delivery/TodayPickups";
import PendingTasks from "./pages/delivery/PendingTasks";
...
// import DeliveryAttendance from "./pages/delivery/DeliveryAttendance"; // File doesn't exist
...
import BarrelRegistration from "./pages/admin/BarrelRegistration";
import BarrelManagement from "./pages/admin/BarrelManagement";
// import Attendance from "./pages/admin/Attendance"; // File doesn't exist
  ...
  return (
    <RoleThemeProvider>
      <Routes>
        ...
        />
        <Route
          path="/delivery/today-deliveries"
          element={
            <DeliveryProtectedRoute>
              <DeliveryDashboardLayout>
                <TodayDeliveries />
        ...
        />
        <Route
          path="/admin/barrel-registration"
          element={
            <AdminProtectedRoute>
              <AdminDashboardLayout>
                <BarrelRegistration />
        ...
        <Route
          path="/accountant"
          element={<Navigate to="/accountant/latex" replace />}
        />
        <Route
          path="/accountant/debug-route"
          element={React.createElement(require('./pages/VerifySidebar').default)}
        />
        <Route
        ...
        {/* New Antigravity Accountant Routes */}
        <Route
        ...
        <Route
          ...
          element={
            <AccountantProtectedRoute>
              <AccountantDashboardLayout>
                <AccountantAuditTrail />
              </AccountantDashboardLayout>
            </AccountantProtectedRoute>
          }
        />
        <Route
          path="/accountant/profitability"
          element={
            <AccountantProtectedRoute>
              <AccountantDashboardLayout>
                <AccountantProfitability />
              </AccountantDashboardLayout>
            </AccountantProtectedRoute>
          }
        />
        ...
        <Route
          path="/probe"
          element={<React.Fragment>{React.createElement(require('./pages/Probe').default)}</React.Fragment>}
        />
      </Routes>
    </RoleThemeProvider>
  );
